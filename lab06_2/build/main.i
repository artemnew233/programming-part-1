...
{
    double out;
    do { long _ums_n = (long)(5); if (_ums_n <= 0) { (out) = 0.0; } else { double _ums_a1 = (double)(2.0); double _ums_d = (double)(3.0); (out) = ((double)_ums_n) / 2.0 * (2.0 * _ums_a1 + ((double)(_ums_n) - 1.0) * _ums_d); } } while (0);
    printf("AR: a1=2,d=3,n=5 -> S = %.6f (expected 40)\n", out);

    do { long _ums_n = (long)(4); if (_ums_n <= 0) { (out) = 0.0; } else { double _ums_a1 = (double)(1.5); double _ums_d = (double)(-0.5); (out) = ((double)_ums_n) / 2.0 * (2.0 * _ums_a1 + ((double)(_ums_n) - 1.0) * _ums_d); } } while (0);
    printf("AR: a1=1.5,d=-0.5,n=4 -> S = %.6f\n", out);

    do { long _ums_n = (long)(0); if (_ums_n <= 0) { (out) = 0.0; } else { double _ums_a1 = (double)(10.0); double _ums_d = (double)(1.0); (out) = ((double)_ums_n) / 2.0 * (2.0 * _ums_a1 + ((double)(_ums_n) - 1.0) * _ums_d); } } while (0);
    printf("AR: n=0 -> S = %.6f (expected 0)\n", out);

    do { long _ums_n = (long)(4); if (_ums_n <= 0) { (out) = 0.0; } else { double _ums_a0 = (double)(1.0); double _ums_q = (double)(2.0); const double _ums_eps = 1e-12; if (fabs(_ums_q - 1.0) < _ums_eps) { (out) = ((double)_ums_n) * _ums_a0; } else { double _ums_qn = pow(_ums_q, (double)_ums_n); (out) = _ums_a0 * (1.0 - _ums_qn) / (1.0 - _ums_q); } } } while (0);
    printf("GEOM: a0=1,q=2,n=4 -> S = %.6f (expected 15)\n", out);

    do { long _ums_n = (long)(5); if (_ums_n <= 0) { (out) = 0.0; } else { double _ums_a0 = (double)(3.0); double _ums_q = (double)(1.0); const double _ums_eps = 1e-12; if (fabs(_ums_q - 1.0) < _ums_eps) { (out) = ((double)_ums_n) * _ums_a0; } else { double _ums_qn = pow(_ums_q, (double)_ums_n); (out) = _ums_a0 * (1.0 - _ums_qn) / (1.0 - _ums_q); } } } while (0);
    printf("GEOM: a0=3,q=1,n=5 -> S = %.6f (expected 15)\n", out);

    do { long _ums_n = (long)(3); if (_ums_n <= 0) { (out) = 0.0; } else { double _ums_a0 = (double)(2.0); double _ums_q = (double)(0.5); const double _ums_eps = 1e-12; if (fabs(_ums_q - 1.0) < _ums_eps) { (out) = ((double)_ums_n) * _ums_a0; } else { double _ums_qn = pow(_ums_q, (double)_ums_n); (out) = _ums_a0 * (1.0 - _ums_qn) / (1.0 - _ums_q); } } } while (0);
    printf("GEOM: a0=2,q=0.5,n=3 -> S = %.6f (expected 3.5)\n", out);

    do { long _ums_n = (long)(3); if (_ums_n <= 0) { (out) = 0.0; } else { double _ums_a0 = (double)(5.0); double _ums_q = (double)(-2.0); const double _ums_eps = 1e-12; if (fabs(_ums_q - 1.0) < _ums_eps) { (out) = ((double)_ums_n) * _ums_a0; } else { double _ums_qn = pow(_ums_q, (double)_ums_n); (out) = _ums_a0 * (1.0 - _ums_qn) / (1.0 - _ums_q); } } } while (0);
    printf("GEOM: a0=5,q=-2,n=3 -> S = %.6f\n", out);

    do { long _ums_n = (long)(0); if (_ums_n <= 0) { (out) = 0.0; } else { double _ums_a0 = (double)(1.0); double _ums_q = (double)(2.0); const double _ums_eps = 1e-12; if (fabs(_ums_q - 1.0) < _ums_eps) { (out) = ((double)_ums_n) * _ums_a0; } else { double _ums_qn = pow(_ums_q, (double)_ums_n); (out) = _ums_a0 * (1.0 - _ums_qn) / (1.0 - _ums_q); } } } while (0);
